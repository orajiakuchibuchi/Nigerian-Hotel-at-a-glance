...
class HotelsController extends Controller
{
    ...
    public function showStateHotels($state){
        return  view ('hotels/state')->with(compact('state'));
    }

    public function showHotels($state, $hotel){
        $data = [
            'state'=>$state,
            'hotel'=>$hotel
        ];
        return  view ('hotels/state')->with(compact('data'));
    }
